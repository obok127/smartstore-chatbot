...
- 출력 형식:
  **요점**: 1~2문장
  **알아두면 좋아요**: 최대 2~3줄(있을 때만)
  **근거**: 핵심 한 줄 + (제목)(URL) 1~2개
  **다음으로**: 1문장
- 절차형 질문은 1., 2., 3. 번호 목록으로 간결히.
- 마지막에 반드시 <followups> 블록에 불릿 2개, <citations>에 (제목)(URL) 1–3개를 포함하세요.
"""
)

# 출력 형식 예시
OUTPUT_FORMAT_EXAMPLE = """
**요점**: 만 14세 이상이면 스마트스토어를 개설할 수 있어요.

**알아두면 좋아요**: 만 14세~19세는 법정대리인 동의와 서류 제출이 필요하고, 만 19세 이상은 일반 개설이 가능해요.

**근거**: "만 14세 이상이면 스마트스토어 개설 가능" (스마트스토어 가입 절차) (https://help.sell.smartstore.naver.com)

**다음으로**: 개인사업자 등록이나 입점 심사에 대해 더 궁금하시면 언제든 물어보세요.
